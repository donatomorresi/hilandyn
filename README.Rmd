...
`hilandyn` provides an implementation of the High-dimensional detection of Landscape Dynamics algorithm (Morresi et al. 2024) for mapping forest disturbance dynamics by segmenting high-dimensional Landsat time series into linear trends.
